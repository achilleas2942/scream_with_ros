...
VIDEO_FILE="/home/oem/Pictures/AEROTRAIN/GC/video_2024-05-20_11-58-16.mp4"

VIDEOSRC="filesrc location=$VIDEO_FILE ! decodebin ! videoconvert ! video/x-raw,format=I420,width=1280,height=720,framerate=50/1"
